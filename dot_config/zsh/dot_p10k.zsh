# Generated by Powerlevel10k configuration wizard on 2025-01-31 at 14:50 CET.
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%11F' # bright yellow foreground
      local   modified='%6F'  # cyan foreground
    ...
    # Display "W" if the latest commit's summary contains "wip" or "WIP".
